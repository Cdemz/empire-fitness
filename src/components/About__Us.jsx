    ...
    <div className=" ">
      ...
      <div className="bg-white p-6 md:p-8 flex flex-col gap-5 md:flex-row ">
        <div className="md:w-[50%] h-full">
          <h2 className="text-[#adf802] text-2xl font-bold">About our gym</h2>
          ...
          <div>
            <ul className="flex flex-col gap-8 mt-4 w-[80%]">
              ...
              <li className="flex items-center">
                <div>
                  <FaDumbbell className="mr-4 text-2xl text-[#adf802]" />
                </div>
                <div>
              ...
              <li className="flex items-center">
                <div>
                  <FaHardHat className="mr-4 text-2xl text-[#adf802]" />
                </div>
                <div>
                  <h4 className="text-lg font-bold">
              ...
              <li className="flex items-center">
                <div>
                  <FaUsers className="mr-4 text-2xl text-[#adf802]" />
                </div>
                <div>
                  <h4 className="text-lg font-bold">
