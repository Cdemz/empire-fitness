    ...
    <div className="text-white p-6 md:p-8 flex flex-col items-center md:flex-row md:gap-0 gap-4">
      ...
      <div className=" flex flex-col gap-6 md:w-[50%] md:gap-10 md:top-[-2.7em] md:relative md:px-4">
        <h1 className="text-4xl font-bold">
          {' '}
          Training <span className="text-[#adf802]">Video</span>
        </h1>
        <h5>
        ...
        <a
          href="https://www.instagram.com/p/CrJCZoCrmFV/?igshid=MDJmNzVkMjY="
          target="_blank"
        >
          <button className="bg-[#adf802] px-4 py-2 font-semibold rounded-lg">
            View More
          </button>
        </a>
      </div>
